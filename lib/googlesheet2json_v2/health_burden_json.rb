...
def health_burden_json

  # 直近１週間の陽性者data
  last7days = PATIENTS.select { |d| Date.parse(d['確定日']) > Date.parse(LAST_DATE).days_ago(7) }
  ...
  b4 = {
    ...
    s40: Rational('87.1'),
    s50: Rational('91.7'),
    s60: (Rational('91.6') + Rational('89.4')) / Rational('2'),
    s70: (Rational('97.8') + Rational('95.5') + Rational('101.5') + Rational('102.7')) / Rational('4')
  }
  ...
  b5 = {
    ...
    s40: Rational('67.4'),
    s50: Rational('80.0'),
    s60: (Rational('85.7') + Rational('86.3')) / Rational('2'),
    s70: (Rational('94.8') + Rational('91.9') + Rational('96.5') + Rational('94.5')) / Rational('4')
  }
  ...
  # 検査陽性者数の今週/先週比
  b24 = Rational(POSITIVE_BY_DIAGNOSED[-7..].reduce(0) { |a, v| a + v['count'].to_i }) / Rational(POSITIVE_BY_DIAGNOSED[-14..-8].reduce(0) { |a, v| a + v['count'].to_i })
